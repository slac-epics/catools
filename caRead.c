...
char *readFile0(filename,noName)
char *filename;
int *noName;
{
char *ptr;
...
while(*(ptr+end-1) == '\t' || *(ptr+end-1) == ' ')  end--;
if (end < i) { *(ptr+i) = ' '; *(ptr+end) = 0; }
else
		*(ptr+i) = 0;
		l++; 
		}
