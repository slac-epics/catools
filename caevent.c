...
chandata *pchandata;
	...
	/* get new value */
        ...
        pchandata->upper_alarm_limit = (float)((struct dbr_ctrl_double *)args.dbr)->upper_alarm_limit;
        pchandata->upper_warning_limit = (float)((struct dbr_ctrl_double *)args.dbr)->upper_warning_limit ;
        pchandata->lower_warning_limit = (float)((struct dbr_ctrl_double *)args.dbr)->lower_warning_limit ;
        pchandata->lower_alarm_limit = (float)((struct dbr_ctrl_double *)args.dbr)->lower_alarm_limit ;
        pchandata->upper_ctrl_limit = (float)((struct dbr_ctrl_double *)args.dbr)->upper_ctrl_limit ;
        pchandata->lower_ctrl_limit = (float)((struct dbr_ctrl_double *)args.dbr)->lower_ctrl_limit ;
...
/******************************************************
  add a monitor list
******************************************************/
void ca_monitor_add_event_array(noName,pvName)
int noName;
char **pvName;
{
...
******************************************************/
void ca_monitor_clear_event_array(noName,pvName)
int noName;
char **pvName;
{
int status,command_error=0;
...
/* automatically add a change connection event */
	...
	if (CA.PEND_EVENT_ON) ca_pend_event(0.00001);
	}
}
...
******************************************************/
void ca_monitor_string_change_event(args)
struct event_handler_args args;
{
chandata *pchandata;
double time;
