...
******************************************************/
void
ca_monitor_value_change_event_queue(args)
...
******************************************************/
void
ca_monitor_value_change_event_queue3(args)
     struct event_handler_args args;
{
    chandata *pchandata;
    int ne;
...
******************************************************/
int
ca_monitor_queue_get(pvName, vals, overflow, mode)
     int *overflow, mode;
     char *pvName;
     double *vals;
{
...
******************************************************/
int
ca_monitor_queue_zero(int noName, char **pvName)
{
...
******************************************************/
int
ca_monitor_queue_add(noName, pvName, maxvalues, mode)
     int noName, mode;
     char **pvName;
     int *maxvalues;
{
...
******************************************************/
int
ca_monitor_queue_clear(noName, pvName)
     int noName;
     char **pvName;
{
