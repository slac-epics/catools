...
EVENT_QUEUE *ca_alloc_event_trigger_scan(int size,int nonames)
{
int i;
EVENT_QUEUE *pevent;
...
******************************************************/
void ca_monitor_value_change_event_trigger_scan(struct event_handler_args args)
{
chandata *pchan;
double time;
int num,nonames;
...
******************************************************/
int ca_monitor_add_event_trigger_array_scan(chandata *pchandata,int npts,int nonames,char **pvnames)
{
int i=0,status,command_error=0;
	...
	pchandata->p_event_queue = 
           (EVENT_QUEUE *)ca_alloc_event_trigger_scan(npts,nonames);
...
******************************************************/
int ca_monitor_clear_event_trigger_array_scan(int noName,char **pvName)
{
...
******************************************************/
int ca_monitor_get_value_trigger_scan(char *pvName,double *vals)
{
...
******************************************************/
int ca_monitor_zero_event_trigger_array_scan(int noName,char **pvName)
{
